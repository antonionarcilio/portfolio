      ...
      {show && (
        ...
        >
          ...
          >
            ...
            <motion.button
              className="absolute top-3 right-[14px] bg-transparent border border-cv-border text-cv-cyan font-cv-mono text-[16px] w-7 h-7 flex items-center justify-center cursor-pointer leading-none"
              onClick={onClose}
