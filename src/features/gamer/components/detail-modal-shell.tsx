...
/**
 * Shared chrome for the gamer detail modals (project, experience, achievement image):
...
export function DetailModalShell({
  ...
  drawerContentClassName = 'z-[300] bg-cv-panel border-t border-cv-border cursor-gamer-default font-cv-mono',
  children,
}: {
  show: boolean;
  onClose: () => void;
        ...
        <div
          ...
          className={
            isDrawer
              ...
              : `relative bg-transparent backdrop-blur-[18px] border border-cv-border shadow-[inset_0_0_30px_rgba(43,214,255,0.05),0_8px_24px_rgba(0,0,0,0.5),0_0_18px_rgba(43,214,255,0.18)] outline-none cursor-gamer-default ${panelClassName}`
          }
