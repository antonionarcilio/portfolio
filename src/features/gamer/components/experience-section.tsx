          ...
          >
            <div>
              <div className="flex items-baseline gap-[8px] text-[14px] max-[520px]:pr-[30px]">
                <span className="text-cv-text max-[520px]:truncate max-[520px]:min-w-0">{item.company}</span>
            ...
            <Tooltip title="Ver detalhes" description="Abre o modal com informações completas" placement="left">
              <button
                type="button"
                className="absolute top-[17px] right-[17px] text-[10px] text-cv-cyan tracking-[0.16em] uppercase border border-cv-cyan-dim px-[9px] py-[3px] max-[520px]:p-[4px] bg-[rgba(43,214,255,0.06)] backdrop-blur-[18px] whitespace-nowrap cursor-gamer-pointer"
