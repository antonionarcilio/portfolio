...
export function EmptyState({
  ...
  return (
    <div
      role="status"
      className="flex flex-col items-center justify-center gap-[8px] border border-dashed border-cv-border bg-cv-panel px-[18px] pt-[32px] pb-[36px] text-center cursor-gamer-default"
    >
