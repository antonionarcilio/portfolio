...
export function EmptyState({
  ...
  const t = useTranslations('gamified.emptyState');
  ...
  return (
    <div
      role="status"
      className={clsx(
        'flex flex-col items-center justify-center gap-[8px] border border-dashed border-cv-border bg-cv-panel px-[18px] text-center cursor-gamified-default',
        className,
      )}
    >
