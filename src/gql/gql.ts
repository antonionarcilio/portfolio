 ...
 */
export function gql(
  source: 'query Contacts {\n  contacts {\n    documentId\n    label\n    url\n  }\n}',
): (typeof documents)['query Contacts {\n  contacts {\n    documentId\n    label\n    url\n  }\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
 ...
 */
export function gql(
  source: 'query Stack($documentId: ID!) {\n  stack(documentId: $documentId) {\n    documentId\n    project_name\n    technologies {\n      name\n      proficiency_level\n    }\n  }\n}',
): (typeof documents)['query Stack($documentId: ID!) {\n  stack(documentId: $documentId) {\n    documentId\n    project_name\n    technologies {\n      name\n      proficiency_level\n    }\n  }\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
  source: 'query Stacks {\n  stacks {\n    documentId\n    project_name\n    technologies {\n      name\n      proficiency_level\n    }\n  }\n}',
): (typeof documents)['query Stacks {\n  stacks {\n    documentId\n    project_name\n    technologies {\n      name\n      proficiency_level\n    }\n  }\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
