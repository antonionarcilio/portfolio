...
type Documents = {
  ...
  'query Projects($sort: [String], $filters: ComponentPortfolioProjectFiltersInput, $locale: I18NLocaleCode) {\n  portfolio(locale: $locale) {\n    projects(sort: $sort, filters: $filters) {\n      id\n      company\n      company_url\n      project_name\n      desc\n      start_date\n      end_date\n      stack {\n        technologies {\n          name\n          proficiency_level\n        }\n      }\n      preview {\n        url\n        width\n        height\n        formats\n        alternativeText\n      }\n    }\n  }\n}': typeof types.ProjectsDocument;
  'query Skills($locale: I18NLocaleCode, $sort: [String], $techSort: [String]) {\n  portfolio(locale: $locale) {\n    documentId\n    skills(sort: $sort) {\n      id\n      skill_group {\n        name\n        short_description\n      }\n      technologies(sort: $techSort) {\n        documentId\n        name\n        proficiency_level\n      }\n      icon {\n        documentId\n        name\n        width\n        height\n        url\n      }\n    }\n  }\n}': typeof types.SkillsDocument;
 ...
 */
export function gql(
  source: 'query Projects($sort: [String], $filters: ComponentPortfolioProjectFiltersInput, $locale: I18NLocaleCode) {\n  portfolio(locale: $locale) {\n    projects(sort: $sort, filters: $filters) {\n      id\n      company\n      company_url\n      project_name\n      desc\n      start_date\n      end_date\n      stack {\n        technologies {\n          name\n          proficiency_level\n        }\n      }\n      preview {\n        url\n        width\n        height\n        formats\n        alternativeText\n      }\n    }\n  }\n}',
): (typeof documents)['query Projects($sort: [String], $filters: ComponentPortfolioProjectFiltersInput, $locale: I18NLocaleCode) {\n  portfolio(locale: $locale) {\n    projects(sort: $sort, filters: $filters) {\n      id\n      company\n      company_url\n      project_name\n      desc\n      start_date\n      end_date\n      stack {\n        technologies {\n          name\n          proficiency_level\n        }\n      }\n      preview {\n        url\n        width\n        height\n        formats\n        alternativeText\n      }\n    }\n  }\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
  source: 'query Skills($locale: I18NLocaleCode, $sort: [String], $techSort: [String]) {\n  portfolio(locale: $locale) {\n    documentId\n    skills(sort: $sort) {\n      id\n      skill_group {\n        name\n        short_description\n      }\n      technologies(sort: $techSort) {\n        documentId\n        name\n        proficiency_level\n      }\n      icon {\n        documentId\n        name\n        width\n        height\n        url\n      }\n    }\n  }\n}',
): (typeof documents)['query Skills($locale: I18NLocaleCode, $sort: [String], $techSort: [String]) {\n  portfolio(locale: $locale) {\n    documentId\n    skills(sort: $sort) {\n      id\n      skill_group {\n        name\n        short_description\n      }\n      technologies(sort: $techSort) {\n        documentId\n        name\n        proficiency_level\n      }\n      icon {\n        documentId\n        name\n        width\n        height\n        url\n      }\n    }\n  }\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
