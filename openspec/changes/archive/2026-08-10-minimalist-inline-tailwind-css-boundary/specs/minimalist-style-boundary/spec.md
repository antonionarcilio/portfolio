...
Define uma fronteira verificável para que estilos locais e simples do Minimalist sejam declarados junto ao componente, mantendo no CSS apenas regras contextuais, comportamentais ou visualmente compostas.
